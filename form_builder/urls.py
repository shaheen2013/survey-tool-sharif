...
from form_builder.views import HomeView, QuestionTypeView, SurveyView, SurveyPreview, surveyList, SurveyUpdateView, \
    UpdatePage
...
urlpatterns = [
    ...
    path('preview/<int:id>', SurveyPreview.as_view()),
